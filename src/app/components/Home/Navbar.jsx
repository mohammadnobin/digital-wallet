      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/features" className="text-gray-700 hover:text-primary font-medium text-sm transition">Features</Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-0 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <Link href="/product" className="block px-4 py-2 text-gray-700 hover:bg-indigo-50 hover:text-primary text-sm transition">Product</Link>
                <Link href="/faq" className="block px-4 py-2 text-gray-700 hover:bg-indigo-50 hover:text-primary text-sm transition">FAQ</Link>
                <Link href="/testimonials" className="block px-4 py-2 text-gray-700 hover:bg-indigo-50 hover:text-primary text-sm transition">Testimonials</Link>
              </div>
            </div>

            <Link href="/blog" className="text-gray-700 hover:text-primary font-medium text-sm transition">Blog</Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            {session ? (
              <Link href="/dashboard">
                <button className="bg-primary text-white font-semibold px-6 py-2 rounded-full hover:bg-indigo-800 transition">
                  Dashboard
                </button>
              </Link>
            ) : (
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-1 border-t">
            ...
            <Link href="/features" className="block text-gray-700 hover:bg-gray-50 font-medium text-sm py-2 px-2 rounded transition">Features</Link>
            <Link href="/blog" className="block text-gray-700 hover:bg-gray-50 font-medium text-sm py-2 px-2 rounded transition">Blog</Link>
