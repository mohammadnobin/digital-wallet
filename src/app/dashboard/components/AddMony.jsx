...
const AddMoneyPage = () => {
  ...
  const calculateFee = () => {
    const selectedMethodData = fundingSources.find(
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your wallet has been funded and is ready to use.
          </p>
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold">
                {
                  fundingSources.find((m) => m.id === selectedMethod)
                    ?.processingTime
                }
              </span>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-sm p-6 text-white">
                ...
                <p className="text-3xl font-bold mb-2">${currentBalance}</p>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="font-medium">
                      ${remainingDaily.toFixed(2)} / ${dailyAddLimit.toFixed(2)}
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${
                          ((dailyAddLimit - remainingDaily) / dailyAddLimit) *
                          100
                        }%`,
                      }}
                    ></div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${
                          ((monthlyAddLimit - remainingMonthly) /
                            monthlyAddLimit) *
                          100
                        }%`,
                      }}
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-gray-700">
                    Use debit cards for instant transfers
                  </p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                  <p className="text-gray-700">
                    Bank transfers are free but take longer
                  </p>
                </div>
                <div className="flex items-start space-x-2">
