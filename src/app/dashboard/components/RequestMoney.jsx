        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="mt-4 flex gap-3 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-blue-900">Request Information</p>
                <p className="text-sm text-blue-700 mt-1">
                  Recipients will receive a notification and can pay directly through the app or via email link.
                </p>
              </div>
            </div>
          </div>
