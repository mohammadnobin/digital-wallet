...
const ShareQRPage = () => {
    ...
    const handleDownload = () => {
        Swal.fire('Download', 'QR Code downloaded successfully!', 'success');
    };

    const handleShare = () => {
        Swal.fire('Share', 'QR Code shared successfully!', 'success');
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-6">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    {/* QR Code Display */}
                    <div className="p-8">
                        <div className="bg-white border-8 border-gray-100 rounded-2xl p-8 text-center">
                            {/* QR Code SVG */}
                            <div className="bg-white w-64 h-64 mx-auto mb-6 relative">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-gray-500">ID: {userData.userId}</p>
                            </div>
                        </div>
