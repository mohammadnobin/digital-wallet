...
//     { icon: Users, label: "Admin Dashboard", href: "/dashboard/adminDashboard" },
...
export default function Sidebar({ user }) {
  ...
  useEffect(() => {
    ...
    } else if (user?.role === "user" && pathname === "/dashboard/adminDashboard") {
  ...
  const adminMenuItems = [
    { icon: BarChart2, label: "Admin Dashboard", href: "/dashboard/adminDashboard" },
    { icon: Users, label: "User Management", href: "/dashboard/userManagement" },
