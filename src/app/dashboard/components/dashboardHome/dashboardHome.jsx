...
//   // ✅ Use total balance from user data (fallback 0)
//   const totalBalance = user?.balance?.toFixed(2) || '0.00';
...
//               {showBalance && stat.label === 'Total Balance' ? stat.value : 
//               (stat.label === 'Total Balance' ? '•••••' : stat.value)}
//             </div>
//           </div>
//         ))}
//       </div>

//       {/* Rest of dashboard (cards, quick actions, transactions, etc.) */}
//       {/* You can keep your previous dashboard sections below unchanged */}
//     </div>
//   );
// }
